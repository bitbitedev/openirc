...
public class TestMessage {
	 ...
	 public void prefixChecks() {
		 assertThrows(MessagePrefixException.class, () -> new Message("prefix", "command", "param, param, param"));
		 assertThrows(MessagePrefixException.class, () -> new Message(": prefix", "command", "param, param, param"));
	 ...
	 public void legthChecks() {
		 ...
		 assertThrows(MessageLengthExceededException.class, () -> new Message("", "command",
		 ...
		 assertThrows(MessageLengthExceededException.class, () -> new Message("", "123",
