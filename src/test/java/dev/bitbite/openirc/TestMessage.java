...
public class TestMessage {
	...
	public void prefixChecks() throws MessagePrefixException, MessageLengthExceededException, MalformedMessageException {
		assertThrows(MalformedMessageException.class, () -> new Message(null, null, null));
		assertThrows(MessagePrefixException.class, () -> new Message("", "CMD", null));
		assertThrows(MessagePrefixException.class, () -> new Message("pre fix", "CMD", null));
		assertThrows(MalformedMessageException.class, () -> new Message(null, "CMD", ""));
		assertEquals("prefix", new Message(":prefix", "CMD", null).prefix);
	}
	...
	public void lengthChecks() {
		...
		assertThrows(MessageLengthExceededException.class, () -> new Message(null, "COMMAND",
			...
			+ "bUHIBuSIOTFgHy4LknVpZyO1FtOf7sCab"));
		assertThrows(MessageLengthExceededException.class, () -> new Message(":prefix", "123",
			...
			+ "9t94xvUT5Fg6IKVRDJiwElVxLKzys"));
		assertThrows(MessageLengthExceededException.class, () -> new Message(null, "123",
			...
			+ "aar7TK2JSinRXqSgdHjagMtEEZHXUHav3O0ba"));
	}
}
